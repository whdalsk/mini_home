...
<script type="text/javascript">
	function signUpBtnCheck() {
		...
		var pw2 = document.getElementById("user_pwreturn").value;
    ...
    <div class="wrap">
        ...
        <body>
            <div class="wrap">
              <main>
                <div>
                  <h1><a href="#">싸이월드 회원가입</a></h1>
                  <form name="joinform" action="signUpCommit.do" method="post">
                    <fieldset>
                      ...
                      />
                      <label for="user_pwd" class="screen_out">비밀번호</label>
                      <input
                        id="user_pw"
                        type="password"
                        name="m_pw"
                      ...
                      />
                      <label for="user_pwreturn" class="screen_out">비밀번호 확인</label>
                      <input
                        id="user_pwreturn"
                        type="password"
                        name="m_pw2"
                      ...
                      <input
                        ...
                        maxlength="13"
                      />
                      <label for="user_email" class="screen_out">메일주소</label>
                      <input
                        id="user_email"
                        type="text"
                        name="m_email"
                        placeholder="seogyeong@naver.com"
                      />
                      
                        <div class="contract">약관동의체크</div>
                        <br>
                        <table border="0" cellspacing="0" cellpadding="2"  align="center">
                            <tr height="10"> 
                                <td>
                                    <textarea cols="47" rows="14" readonly>Cummunity 서비스약관 (2022. 01. 01 부터 유효)
                        ...
                        <br>
                        <div>
                          <input type="checkbox" id="agree" name="agree"><b>약관에 동의합니다  </b>&nbsp;
                      <input type="button" class="signUpBtn" value="가입" onclick="signUpBtnCheck()"/>
                      </div>
                      </fieldset>
                      </form>
                    <ul>
