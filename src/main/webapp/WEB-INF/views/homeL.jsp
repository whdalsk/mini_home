...
<head>
	...
	<script>
		...
		btn;
		function edit(){
			editView=document.getElementById("info");
			...
			editView.appendChild(content);
			editView.appendChild(btn);
			btn.addEventListener("click",clickBtn);
		}
		function clickBtn(){
			editView.innerHTML=content.value;
		}
	</script>
</head>
<body>
	<div id="profile">
		<div id="today">
			...
			<select name="feelings">
				...
				<option value="기쁨">신남</option>
				<option value="기쁨">화남</option>
				<option value="기쁨">짜증</option>
			</select>
		</div>
		<div id="photo">
			<!--  <img src="resources/images/홈사진.jpeg" width="100%"> -->
			<img src="resources/images/${dto.h_img}" width="100%">
		</div>
		<div id="info">
<!-- 			<text>ㄱHㄱl면.. 죽는ㄷr..<br></text> -->
			<text>${dto.h_content}<br></text>
		</div>
		<span id="profileMenu">
			<text style="color:#298FA6">▶</text><text style="font-size:12px; font-weight: bold;" onclick="edit()">EDIT</text>
